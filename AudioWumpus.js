/**************************************************************************
* AudioWumpus, Copyright (C) 2025 Juno Presken
* E-mail: juno.presken+AudioWumpus@protonmail.com
*
...
async function playerMoved(inKey = -1){
    ...
    //did they die?
        ...
        if(playerCave == wumpusCave){
            ...
            if(Math.random() < 0.75){//75% chance of wumpus moving
                wumpusCave = caveSystem[Math.floor(Math.random() * 3)];//move to random connected cave
                if(playerCave == wumpusCave){
...
async function shoot(){
    ...
    var arrowPath = [playerCave,0,0,0,0,0];
